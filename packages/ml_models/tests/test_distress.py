...
def test_training_pipeline(seeded_feature_store) -> None:  # noqa: ARG001
...
def test_production_model_predicts_probabilities(seeded_feature_store) -> None:  # noqa: ARG001
