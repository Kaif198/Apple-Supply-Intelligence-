...
def test_training_pipeline_end_to_end(seeded_feature_store) -> None:  # noqa: ARG001
...
def test_promoted_model_loads_from_registry(seeded_feature_store) -> None:  # noqa: ARG001
...
def test_predict_returns_plausible_margin(seeded_feature_store) -> None:  # noqa: ARG001
...
def test_registry_promote_exclusivity(seeded_feature_store) -> None:  # noqa: ARG001
